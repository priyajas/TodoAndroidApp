package com.test.example.todoandroidapp.fragments.update
...
import com.test.example.todoandroidapp.R
import com.test.example.todoandroidapp.data.models.TodoEntity
import com.test.example.todoandroidapp.databinding.FragmentUpdateBinding
import dagger.hilt.android.AndroidEntryPoint
import com.test.example.todoandroidapp.viewmodels.SharedViewModel
...
class UpdateFragment : Fragment() {
    ...
    private fun update() {
        ...
        val priority =
            mSharedViewModel.parsePriority(binding.updateSpPriority.selectedItem.toString())
